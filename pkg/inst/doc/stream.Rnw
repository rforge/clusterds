...
\item
\code{plot(x, dsd=NULL, col_points="gray", col_macro="red", col_micro="black",} ^^J
\code{weights=FALSE, scale=c(1,10), ..., method="pairs", microclusters=FALSE)} which plots the centers
